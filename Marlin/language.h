...
// Please note these are limited to 17 characters!
	...
	#define MSG_DELTA "Delta"
	#define MSG_CONTROL_DELTA_SEGMENTS_PER_SECOND "Seg/Sec"
	#define MSG_CONTROL_DELTA_DIAGONAL_ROD "DiagRod"
	#define MSG_CONTROL_DELTA_RADIUS "Radius"
