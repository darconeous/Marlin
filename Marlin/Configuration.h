...
#define STRING_CONFIG_H_AUTHOR "(rquattle, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Xeranon"
...
#define THERMAL_PROTECTION_CHAFILAMENT_RUNOUT_SENSORMBER // Enable thermal protection for the heated chamber
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 0, -80, 300 }
  #define NOZZLE_PARK_XY_FEEDRATE HOMING_FEEDRATE_Z/60   // (mm/s) X and Y axes feedrate (also used for delta Z axis)
  #define NOZZLE_PARK_Z_FEEDRATE HOMING_FEEDRATE_Z/60    // (mm/s) Z axis feedrate (not used for delta printers)
  #define NOZZLE_PARK_Z_MAX_POS 350
#endif
